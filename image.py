...
class Image:
    ...
    def __init__(self, path=None, img=None):
        ...
        self.gray = cv2.cvtColor(self.image, cv2.COLOR_BGR2GRAY)  # TODO: check if this is not a problem (changes the image to gray without copying first)
    ...
    def edges_laplacian(self, ksize=3):
        return cv2.Laplacian(self.gray, cv2.CV_8U, ksize)  # ddepth - desired depth of dst image  |||    # CV_8U - unsigned char (8-bit))
